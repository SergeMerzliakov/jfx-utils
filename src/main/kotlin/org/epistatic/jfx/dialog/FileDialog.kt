...
package org.epistatic.jfx.dialog
...
/**
 * These are all wrappers around JavaFX FileChooser dialogs
 */

fun openFileDialog(parent: Stage, title: String, lastPath: File, extensionFilter: FileChooser.ExtensionFilter): DialogResult<File> {
...
fun saveFileDialog(parent: Stage, title: String, initialFileName: String, lastPath: File, extensionFilter: FileChooser.ExtensionFilter): DialogResult<File> {
   val chooser = createChooser(title, lastPath, extensionFilter)
...
/**
 * implementor function for all choosers
 */
